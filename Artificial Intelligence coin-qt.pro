TEMPLATE = app
TARGET = Artificial Intelligence coin-qt
VERSION = 1.0.7
...
QRENCODE_INCLUDE_PATH=C:/qrencode-2.0.0
QRENCODE_LIB_PATH=C:/qrencode-2.0.0/.libs
}
...
macx:TARGET = "Artificial Intelligence coin-Qt"
